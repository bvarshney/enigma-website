                    ...
                    {serviceData.map((item, index) => (
                        <AccordionItem
                            ...
                            <AccordionTrigger className="px-[1vw] flex justify-between tablet:py-7 mobile:py-4">
                                ...
                                <div className="flex items-center justify-center w-[2vw] h-[2vw] transition-all duration-500 ease-out service-arrow tablet:h-[40px] tablet:w-[40px]">
                                    <span className="block h-[0.3vw] rotate-90 w-[1.8vw] tablet:h-[5px] tablet:w-[40px] mobile:w-[24px] mobile:h-[4px] absolute bg-current" />
                                    <span className="block h-[0.3vw] w-[1.8vw] tablet:h-[5px] tablet:w-[40px] mobile:w-[24px] mobile:h-[4px] absolute bg-current duration-500 ease-out" />
                                </div>
                            </AccordionTrigger>
                            <AccordionContent className="text-[1.2vw] leading-[1.4] text-justify tracking-[1px] px-[17%] pb-[4vw] pt-[2vw] tablet:text-[3vw] tablet:px-[8%] tablet:pb-[10vw] mobile:text-lg mobile:tracking-wide mobile:leading-normal">
                                {item.content && item.content.map((text, idx) => (
                                    <p key={idx} className="mb-[1.5vw] mobile:mb-4">{text}</p>
                                ))}
                                <LinkButton
...
const serviceData = [
    {
        ...
        title: "Strategy",
        content: [
            "Strategic planning based on insight is the starting point of everything we do. As one of the leading UI UX and web design agencies, we combine strategic thinking, marketing expertise, insights, best practices, and sound judgment to craft effective strategies that turn insights into measurable results.",
    ...
    },
    {
        ...
        title: "UI/UX Design",
        content: [
            "Enigma Digital is a leading UI/UX design agency based in India. We help startups and enterprise companies create digital products, websites, mobile app UIs, and brand experiences.",
    ...
    },
    {
        ...
        title: "Technology",
        content: [
            "Enigma Digital is a professional website design agency specializing in creating effective user experiences for technology firms across various industries, including healthcare, e-commerce, legal services, finance, education, and fashion.",
            "We follow a human-centered, design-led approach to product development—blending cutting-edge technologies with agile methodologies. Our mission is to help you thrive in today’s fast-evolving digital landscape.",
            "We create digital experiences that are not only visually appealing but also highly intuitive and user-friendly. Our front-end development expertise spans HTML, CSS, JavaScript, Vue, React, Angular, GSAP, and WordPress. For mobile app development, we utilize modern frameworks like Ionic and Flutter. On the backend, we build powerful, scalable solutions using PHP, NodeJS, and Python.",
        ],
